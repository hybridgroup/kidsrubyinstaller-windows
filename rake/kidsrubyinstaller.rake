...
task :require_kidsrubyinstaller do

  require "kidsrubyinstaller"

end

desc "Bootstrap KidsRubyInstaller development environment (gems)"
task :bootstrap do
...
task :build => [ :require_kidsrubyinstaller ] do

  KidsRubyInstaller.build!

end

desc "Package all components into a single executable installer into pkg/."
task :package => [ :require_kidsrubyinstaller ] do

  KidsRubyInstaller.package!
