...
en.WelcomeLabel2=This will install [name/ver] on your computer which includes Ruby 1.8.7, Git, Sqlite3, DevKit, Rails 3, and KidsRuby.  Please close any console applications before continuing.
...
[Icons]
Name: {group}\Kids Ruby Interactive; Filename: "{app}\{#RubyPath}\bin\ruby.exe"; WorkingDir: {app}\{#RubyPath} ; Parameters: -S kidsruby; IconFilename: {app}\{#RubyPath}\bin\ruby.exe; Flags: createonlyiffileexists
