...
WelcomeLabel2=このコンピューターに[name/ver]をインストールします。このプログラムには、Ruby 1.9.3・Git・Sqlite3・DevKit・Rails 3・KidsRubyが含まれています。インストールを続ける前に、コンソールアプリケーションをすべて閉じてください。
WizardLicense=KidsRuby使用許諾契約
LicenseLabel=
